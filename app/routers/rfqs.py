...
# app/routers/rfqs.py
# -----------------------------------------------------------------------------
# HTTP endpoints for Request for Quotation (RFQ) CRUD and item management.
#
# POST    /api/v1/rfqs                              — create RFQ
# GET     /api/v1/rfqs                              — list RFQs (paginated)
# GET     /api/v1/rfqs/{rfq_id}                    — get RFQ detail
# PATCH   /api/v1/rfqs/{rfq_id}                    — update RFQ / status
# DELETE  /api/v1/rfqs/{rfq_id}                    — delete DRAFT RFQ
# POST    /api/v1/rfqs/{rfq_id}/items               — add item
# GET     /api/v1/rfqs/{rfq_id}/items               — list items
# DELETE  /api/v1/rfqs/{rfq_id}/items/{item_id}     — remove item
# =============================================================================
