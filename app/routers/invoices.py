...
# -----------------------------------------------------------------------------
# HTTP endpoints for supplier-side invoices created from GRNs.
# This router is a thin wrapper over purchase_invoice_service; it maps
# PurchaseInvoiceResponse to the public InvoiceResponse schema.
#
# POST  /api/v1/invoices/from-grn          — create invoice from a GRN
# GET   /api/v1/invoices                    — list all invoices
# POST  /api/v1/invoices/{id}/approve       — approve a draft invoice
# POST  /api/v1/invoices/{id}/pay           — mark an approved invoice paid
# =============================================================================
