...
# -----------------------------------------------------------------------------
# Metadata record for file attachments on any entity (RFQ, Quotation,
# Invoice, SupplierQuote). Binary content is stored externally (S3 / GCS);
# only the storage key and file metadata are persisted in the database.
# =============================================================================
