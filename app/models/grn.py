...
# app/models/grn.py
# -----------------------------------------------------------------------------
# Goods Receipt Note — records the physical receipt of goods against a
# Purchase Order. One GRN is created per delivery event. Multiple GRNs
# may exist for a single PO when goods arrive in partial shipments.
# =============================================================================
